...
#### **Implementation**     
<div>
The implementation of this command is quite simple. <br>
...
These information will be eventually shown to the user through the <code>Ui</code>.
</div>  

The <i>sequence</i> diagram of what happens when a user executes the <b>info</b> command is as illustrated:   
![info command sequence diagram](images/info_seq.png)
