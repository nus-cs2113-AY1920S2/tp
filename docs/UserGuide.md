...
3. [Features](#3-features)
  * [Command Format](#command-format)
        * [Asking for help with valid commands : `help`](#help-command)
        * [Viewing articles or jobs : `view`](#view-command)
        * [Saving an article or job: `save `](#save-command)
        * [Creating an `article`, `job`, or `note`: `create`](#create-command)
        * [Listing saved/created `article`, `job`, `note`: `list `](#list-command)
        * [Deleting saved/created `article`, `job`, or `note`: `delete `](#delete-command)
        * [Adding an extract to `article`, `job`, or `note`: `list`](#add-command)
