...
* Example: `repeat id/4 p/3d` will repeat task of index 4 (which has to be an event) every 3 days. +
* Expected outcome:
```
...
* Example: `repeat id/4 p/0` will cause task of index 4 to stop repeating.
* Expected outcome:
```
