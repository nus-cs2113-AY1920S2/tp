...
|===
|S/N |As a ... |I can... | So that I can...

|01|user|add assignments, including assignment details|keep track of assignment details
|02|user|add events, including event details|keep track of event details
|03|have a daily view of tasks|see what is important for today only
|===
