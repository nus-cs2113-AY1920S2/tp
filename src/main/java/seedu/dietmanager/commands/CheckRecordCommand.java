...
public class CheckRecordCommand extends Command {
    ...
    public void saveResult(Profile profile) {
        ...
        switch (mealType) {
        case "morning":
            this.result = date + " Morning: " + System.lineSeparator() + record.showBreakfast() + record.showDailyCalories(mealType);
            break;
        case "afternoon":
            this.result = date + " Afternoon: " + System.lineSeparator() + record.showLunch() + record.showDailyCalories(mealType);
            break;
        case "night":
            this.result = date + " Night: " + System.lineSeparator() + record.showDinner() + record.showDailyCalories(mealType);
            break;
        default:
