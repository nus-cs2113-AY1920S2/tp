...
//          System.out.println(semesterData.get("timetable"));
...
//              System.out.println(lesson.get("classNo") + "  " + lesson.get("lessonType") + "  " + lesson.get("day")
//                                        + "  " + lesson.get("weeks") + "  " + lesson.get("startTime") + "  " + lesson.get("endTime"));
