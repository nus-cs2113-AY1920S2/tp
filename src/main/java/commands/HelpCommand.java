...
public class HelpCommand {
    ...
    private static void AddCommands() {
        ...
        System.out.println("Add Dish: add dish; n/NAME; [i/INGREDIENT1, INGREDIENT2, ...];");
        System.out.println("Add Stock: add stock; i/INGREDIENT1; q/QUANTITY; p/PRICE;");
        System.out.println("Add Reservation: add reservation; p/CONTACT_PERSON_NAME; d/DATE; n/NUMBER_OF_GUESTS; c/CONTACT; [m/COMMENTS];");
        System.out.println("");
    }
