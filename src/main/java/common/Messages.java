...
public class Messages {
    ...
    public static final String ADD_SUCCESS_MESSAGE =
            "Added task:" + System.lineSeparator() + "%s" + System.lineSeparator() + "Now you have %d tasks in the list!";
    ...
    public static final String DATE_INCORRECT_OR_INVALID_ERROR_= "Wrong date format or invalid date provided";
