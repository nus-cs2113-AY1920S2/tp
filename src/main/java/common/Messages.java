...
public class Messages {
    ...
    public static final String MESSAGE_STARTENDTIME_OUT_OF_RANGE = "Start and end time must be in HH:MM format in the range 00:00-23:30.";
    ...
    public static final String MESSAGE_MODULECODE_IN_BLACKLIST = " module information unable to be captured from API, please key it in"
