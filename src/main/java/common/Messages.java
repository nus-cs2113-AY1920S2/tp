...
public class Messages {
    ...
    public static final String CLEAR_DONE_SUCCESS_MESSAGE = "All completed tasks[Excluding repeated events] have been "
           + "removed";
    ...
    public static final String REPEAT_EDITCOMMAND_PROMPT =
            "Task Editing Failure. Please enter [edit] command again to edit task!";
