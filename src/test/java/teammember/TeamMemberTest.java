...
public class TeamMemberTest {
    ...
    public void editBlocks_outOfRangeTime() {
        ...
        String invalidOutOfRangeEndTime_Message = myMembers.get(0).editBlocks(true, meetingName, validStartDay, validStartTime, validEndDay, invalidOutOfRangeEndTime);
    ...
    public void editBlocks_outOfRangeDay() {
        ...
        myMembers.add(new TeamMember("TEST_MEMBER1"));
        String invalidOutOfRangeEndDay_Message = myMembers.get(0).editBlocks(true, meetingName, validStartDay, validStartTime, invalidOutOfRangeEndDay, validEndTime);
        assertEquals(invalidOutOfRangeEndDay_Message, MESSAGE_STARTENDDAY_OUT_OF_RANGE);

        myMembers.add(new TeamMember("TEST_MEMBER2"));
        String invalidOutOfRangeStartDay_Message = myMembers.get(1).editBlocks(true, meetingName, invalidOutOfRangeStartDay, validStartTime, validEndDay, validEndTime);
    ...
    public void editBlocks_timeNotInBlocks() {
        ...
        myMembers.add(new TeamMember("TEST_MEMBER1"));
        String invalidFormatStartTime_Message = myMembers.get(0).editBlocks(true, meetingName, validStartDay, invalidFormatStartTime, validEndDay, validEndTime);
