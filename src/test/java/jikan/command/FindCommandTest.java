...
class FindCommandTest {
    ...
    void populateActivityList() throws InvalidTimeFrameException, NameTooLongException {
        ...
        activity1 = new Activity("subject1 quiz", startTime, endTime, duration, tags, allocatedTime);
        activity2 = new Activity("subject2 quiz", startTime, endTime, duration, tags, allocatedTime);
        activity3 = new Activity("subject1 final", startTime, endTime, duration, tags, allocatedTime);
